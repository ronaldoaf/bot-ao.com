...
class API{
	...
	static public function EfetuaLogin(){
	    if(static::$LoginErrorCounter<=3) {	
		    ...
		    if ($register->Success==1) {
            	...
            	mail ('ronaldo.a.f@gmail.com' , 'Erro de login AO' , 'Erro de login AO');
	...
	static public function GetMatches(){
		return static::Command('GetMatches', ['sportsType'=>SPORTS_TYPE_SOCCER, 'marketTypeId'=>MARKETTYPE_LIVE] )->EventSportsTypes[FIRST_ITEM]->Events;
	}
